<?php
/**
 * Archive template for Restaurantes Custom Post Type
 */

get_header();
?>

<main class="site-main restaurantes-page">

    <!-- Hero Section -->
    <section class="restaurantes-hero">
        <div class="restaurantes-hero-content">
            <h1 class="restaurantes-hero-titulo">
                <i class="fas fa-utensils"></i>
                Descubre los Mejores Restaurantes
            </h1>
            <p class="restaurantes-hero-descripcion">Descubre Sabores auténticos y experiencias gastronómicas únicas</p>
        </div>
    </section>

    <!-- Filtros Section -->
    <section class="restaurantes-filtros-section">
        <div class="restaurantes-container">
            <div class="filtros-wrapper">

                <!-- Búsqueda -->
                <div class="filtro-item filtro-busqueda">
                    <label for="restaurantes-search">
                        <i class="fas fa-search"></i>
                        Buscar
                    </label>
                    <input type="text" id="restaurantes-search" placeholder="Buscar por nombre...">
                </div>
                ...
                <div class="filtro-item">
                    ...
                    <select id="filtro-ubicacion">
                        ...
                        $ubicaciones = get_terms(array(
                            'taxonomy' => 'ubicacion-restaurante',
                            'hide_empty' => true,
                        ));
    ...
    <!-- Grid de Hoteles -->
    <section class="restaurantes-grid-section">
        <div class="restaurantes-container">
                        ...
                        <article class="restaurante-card"
                            ...
                            <div class="restaurante-card-imagen">
                                ...
                                <?php if ($categorias && !is_wp_error($categorias)) : ?>
                                    <span class="restaurante-badge"><?php echo esc_html($categorias[0]->name); ?></span>
                                <?php endif; ?>

                                <!-- Galería Icon -->
                                <?php if (!empty($galeria_urls) && count($galeria_urls) > 1) : ?>
                                    <button class="restaurante-galeria-btn" data-restaurante-id="<?php echo get_the_ID(); ?>">
                            ...
                            <div class="restaurante-card-contenido">

                                <!-- Header con Título y Ubicación -->
                                <div class="restaurante-card-header">
                                    <h3 class="restaurante-titulo">
                                        <a href="<?php the_permalink(); ?>"><?php the_title(); ?></a>
                                    </h3>
                                    <?php if ($ubicaciones && !is_wp_error($ubicaciones)) : ?>
                                        <p class="restaurante-ubicacion">
                                            <i class="fas fa-map-marker-alt"></i>
                            ...
                            </div><!-- .restaurante-card-contenido -->
